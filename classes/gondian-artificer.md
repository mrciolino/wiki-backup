...
### Level 5 Upgrades (Select 1, must have 3rd-level upgrade from the same path)
...
### Level 9 Upgrades (Select 1, must have 3rd and 5th-level upgrades from the same path)
...
### Level 15 Upgrades (Select 1, must have 3rd, 5th, and 9th-level upgrades from the same path)
